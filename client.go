// Package client provides a specialized HTTP client for interacting with the api-foot-adapter microservice.
...
// Client is a struct that encapsulates necessary details and methods to interact with the api-foot-adapter microservice.
...
//
// Fields:
//   - url: Base URL of the api-foot-adapter microservice. This is the root address to which all API endpoints are appended.
